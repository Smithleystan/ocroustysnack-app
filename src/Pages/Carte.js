    ...
    return (
        <div>
         ...
         <div className='bref'>
            ...
            <Link to="../burger"><div className='imgnav imgm2'><div><div><h1>Hamburgers</h1></div><div><h1>&</h1></div><div><h1>Galettes</h1></div></div></div></Link>
            ...
            <Link to="../drink"><div className="imgnav imgm5"><h1>Boisson</h1></div></Link>
         </div>
         </div>
        </div>
      )
